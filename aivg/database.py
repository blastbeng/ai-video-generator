...
class Database:
  ...
  params = Table(PARAMS, metadata,
                ...
                Column('lora', String(500), nullable=False),
                Column('lora_weight', Float, nullable=False),
